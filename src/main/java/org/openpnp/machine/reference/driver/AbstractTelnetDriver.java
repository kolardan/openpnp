...
import org.openpnp.machine.reference.driver.wizards.AbstractTelnetDriverConfigurationWizard;
 ...
 */
public abstract class AbstractTelnetDriver implements ReferenceDriver, Closeable {
    private static final Logger logger = LoggerFactory.getLogger(AbstractTelnetDriver.class);
    ...
    protected DataOutputStream outputSocket = null;
    protected DataInputStream inputSocket = null;
...
//    protected OutputStream output;
     ...
     * @throws IOException
     */
    protected String readLine() throws SocketTimeoutException, IOException {
        StringBuffer line = new StringBuffer();
        while (true) {
            try {
                 int ch = inputSocket.readByte();// input.read();
                if (ch == -1) {
                    return null;
                }
                else if (ch == '\n' || ch == '\r') {
    ...
    public Wizard getConfigurationWizard() {
        return new AbstractTelnetDriverConfigurationWizard(this);
    }
